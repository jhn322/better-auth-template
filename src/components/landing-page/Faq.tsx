...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'The template uses BetterAuth.js which supports 50+ OAuth providers. Adding additional providers like Google, Discord, or Auth0 is as simple as adding a few lines of code.',
  },
  {
